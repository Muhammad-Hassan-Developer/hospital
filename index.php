...
<head>
    ...
    <title> Heart Disease Prediction By Using Hybird Techniques </title>
    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;">HDP
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    ...
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Heart Disease Prediction By Using Hybird Techniques</h5>
    ...
    <section id="about_us" class="about-us">
        <div class="row no-margin">
            ...
            <div class="col-sm-6 abut-yoiu">
                <h3>About Our Heart Disease Prediction system</h3>
<?php
...
?>
    ...
    <p><?php  echo $row['PageDescription'];?>.</p><?php } ?>
        ...
        <div class="gallery-filter d-none d-sm-block">
            ...
            <button class="btn btn-default filter-button" data-filter="hdpe">Myocardial Infarction</button>
            <button class="btn btn-default filter-button" data-filter="sprinkle">Cardiology</button>
            <button class="btn btn-default filter-button" data-filter="spray"> Coronary Artery Spasm</button>
            <button class="btn btn-default filter-button" data-filter="irrigation">Demand Ischemia</button>
        </div>
        <br/>
...
?>
    ...
    <div class="copy">
            <div class="container">
            Heart Disease Prediction By Using Hybird Techniques
