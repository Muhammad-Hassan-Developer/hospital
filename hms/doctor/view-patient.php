...
<!-- <button class="btn btn-primary waves-effect waves-light w-lg" data-toggle="modal" data-target="#myModal" >Add Medical History</button> -->
  ...
  <a href="prediction.php" target="_blank">
    <button class="btn btn-secondary waves-effect waves-light w-lg">Prediction</button>
  </a>
</p>
...
<div class="modal-footer">
 ...
 <div class="col-md-6">
  <h5 class="over-title margin-bottom-15">Real-Time <span class="text-bold">Readings</span></h5>
  <div class="card">
    <div class="card-body">
      <p><strong>Message:</strong> <span id="api_msg">Loading...</span></p>
      <p><strong>Heart Rate (BPM):</strong> <span id="api_bpm">Loading...</span></p>
    </div>
  </div>
</div>
